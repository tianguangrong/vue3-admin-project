...
//营收统计图表
Mock.mock("https://www.demo.com/api/revenueChart", "get", () => {
  return {
    code: 200,
    success: true,
    data: {
...
//电子地图接口
Mock.mock("https://www.demo.com/api/mapList", "post", () => {
  return {
    code: 200,
    success: true,
    data: stations
...
//订单管理接口
Mock.mock('https://www.demo.com/api/orderList', 'post', (options: any) => {
...
Mock.mock('https://www.demo.com/api/alarmList', "get", () => {
  return {
    code: 200,
    message: "操作成功",
    data: alarmList
...
//会员卡管理接口
Mock.mock('https://www.demo.com/api/member', 'post', (req:any) => {
...
//招商管理分类列表接口
Mock.mock('https://www.demo.com/api/document',"get",()=>{
  return {
    code:200,
    message:"操作成功",
    data:{
...
//权限设置页面
Mock.mock('https://www.demo.com/api/permissionList','post',(req:any)=>{
...
// ]
// //获取当前用户权限
// Mock.mock("https://www.demo.com/api/userAuth","post",(req:any)=>{
...
// //权限设置接口
// Mock.mock("https://www.demo.com/api/setAuth","post",(req:any)=>{
